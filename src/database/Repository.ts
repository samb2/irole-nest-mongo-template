...
interface IRepository<T extends Document> {
    find(where: object, options: IOption, cache: ICache | undefined): Promise<T[]>;

    findOne(where: object, options: IOption, cache: ICache | undefined): Promise<T>;

    findById(id: Types.ObjectId, options: IOption, cache: ICache | undefined): Promise<T>;

    paginate(where: object, options: PaginationOptions, cache: ICache | undefined): Promise<T>;
...
export default class Repository<T extends Document> implements IRepository<T> {
    ...
    // Find
    async find(where: object, options: IOption = {}, cache: ICache | undefined = undefined): Promise<any[]> {
        if (cache) {
    ...
    async findOne(where: object, options: IOption = {}, cache: ICache | undefined = undefined): Promise<any> {
        if (cache) {
    ...
    async findById(id: Types.ObjectId, options: IOption = {}, cache: ICache | undefined = undefined): Promise<any> {
        if (cache) {
